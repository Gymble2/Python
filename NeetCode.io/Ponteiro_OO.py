...
while True:
    ...
    LinkedList.__init__(ListNode)

    if Opc == 1:
        valor = int(input("Insira um valor na cabeça do código"))
        LinkedList.insertHead(valor)

    if Opc == 2:
        valor = int(input("Insira um valor na cauda do código"))
        LinkedList.insertTail(valor)

    if Opc == 3:
        posicao = int(input("Mostra o valor da posição escolhida"))
        LinkedList.get(posicao)

    if Opc == 4:
        posicao = int(input("Remove o valor da posição escolhida"))
        LinkedList.remove(posicao)

    if Opc == 5:
        valor = int(input("Mostrando os valores:"))
